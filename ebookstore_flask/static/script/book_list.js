function updateJumpNav() {
   ...
   if(firstSectionContainer.top >= 40) {
      jumpNav.style.top = (firstSectionContainer.top - 7) + "px";
   }
   else if (lastSectionContainer.bottom <= window.innerHeight - 85) {
      jumpNav.style.top = `${lastSectionContainer.bottom - jumpNav.offsetHeight}px`;
   }
   else {
      jumpNav.style.top = "33px";
   }
}
