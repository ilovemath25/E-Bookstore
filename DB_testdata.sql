...
('Chris',    'Lee',      'Qwerty123',   'Other',  'chris_lee@gmail.com',      NULL,         '1995-03-10', '789 Maple St, Springfield',  '2024-10-28', FALSE, FALSE, TRUE),
...
('妍婷',      '許',       'MyP@ssw0rd',  'Female', 'emily331565@gmail.com',    NULL,         '1999-02-14', '987 Birch St, Springfield',  '2024-10-28', FALSE, FALSE, TRUE),
...
INSERT INTO "Order" ("CMID", "SMID", "Credit_num", "Time", "Ship_address", "Ship_fee", "Status", "Pay_method", "Tot_price") 
VALUES
(10, 9, '5212345678901234', '2024-11-24 09:30:00', '987 Elm Dr, Brockway',           35, 'Shipping',   'Credit card', 1300),
(3, 2,  '4532147890123456', '2024-11-29 10:30:00', '123 Maple St, Springfield',      50, 'Processing', 'Credit card', 1200),
(6, 2,  '5412345678901232', '2024-11-26 13:10:00', '321 Birch Rd, Ogdenville',       40, 'Closed',     'Credit card', 1500),
(5, 9,   NULL,              '2024-11-27 18:20:00', '789 Pine Ln, Capital City',      20, 'Received',   'COD',         600),
(4, 8,  '5312345678901233', '2024-11-28 15:45:00', '456 Oak Ave, Shelbyville',       30, 'Shipping',   'Credit card', 850),
(7, 8,   NULL,              '2024-11-25 11:00:00', '654 Cedar Ct, North Haverbrook', 25, 'Processing', 'COD',         950),
(4, 8,   NULL,              '2024-11-22 16:40:00', '852 Cypress Way, Shelbyville',   20, 'Closed',     'COD',         700),
(3, 2,  '4532147890123456', '2024-11-23 14:50:00', '741 Willow Blvd, Springfield',   50, 'Received',   'Credit card', 1700),
(5, 9,  '3530111333300505', '2024-11-21 12:15:00', '963 Aspen Pkwy, Capital City',   45, 'Processing', 'Credit card', 1400),
(6, 2,   NULL,              '2024-11-20 08:30:00', '357 Redwood Ln, Ogdenville',     30, 'Shipping',   'COD',         1100);
...
('SHIP10OFF', 0.90, 'Shipping', 'Flat 10% Off Shipping Fee', 
 ...
 500),
('SHIPVIP', 0.00, 'Shipping', 'VIP Free Shipping', 
 'Available for VIP members only with a total purchase amount greater than $300. Valid from 2024-10-01 to 2024-12-31.', 
 200),
...
('HERBS2024', 0.92, 'Seasonings', 'Herbs Special Discount', 
 'A discount of 8% on herb products during the promotional period. Valid from 2024-11-15 to 2024-12-15.', 
 100),
